...
_SHAPES = [
    ...
    (
        "austra",
        35.0,
        [(-82, 8), (-58, 2), (-48, -18), (-62, -42), (-75, -52), (-84, -30), (-90, -8)],
    ),
    (
        "eurasia",
        55.0,
    ...
    (
        "meridia",
        75.0,
        [(-15, 32), (15, 30), (40, 18), (48, -8), (30, -32), (12, -34), (-8, -12), (-18, 12)],
    ),
    ("oceania", 92.0, [(112, -12), (140, -10), (154, -24), (148, -40), (122, -38), (110, -24)]),
...
def make_synthetic_continents():
    ...
    names, values, geoms = zip(*[(n, v, Polygon(ring)) for n, v, ring in _SHAPES], strict=True)
