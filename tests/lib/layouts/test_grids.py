...
def test_panel_grid_attaches_named_axes_registry():
    ...
    spec = grid(
        ...
        [
            cell(
                (0, 0),
                paint(lines_panel, df, x="year_id", value="value", hue="series"),
                name="only",
            ),
        ],
    )
...
def test_colorbar_cell_spans_panel_columns():
    ...
    spec = grid(
        ...
        [
            cell(
                (0, 0), paint(lines_panel, df, x="year_id", value="value", hue="series"), name="a"
            ),
            cell(
                (0, 1), paint(lines_panel, df, x="year_id", value="value", hue="series"), name="b"
            ),
